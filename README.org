...
*** Quick Reference
    ...
    List of the keymaps I either use or want to remember.

    - Tabs :: Tab management on normal mode
      - ~gT~: previous tab
      - ~gt~: next tab

    - [[https://neovim.io/doc/user/diagnostic/#diagnostic-defaults][Diagnosis]] :: Default framework for displaying errors or warnings from external tools
    ...
    - [[https://neovim.io/doc/user/various.html#_3.-commenting][Comments]] :: Toogle comments
      - ~gc~: Toggles comment on current line

      - Toggles comments on current function body when cursor inside function
        - ~gcip~: Ruby and code
        - ~gci]~: CSS and JavaScript

      - Toggles comments on current function when cursor in the begining of the function
        - ~gc%~: Ruby, CSS and JavaScript
  ...
  - Language Server Protocol :: [[https://langserver.org][LSP]] is the current trend on editor code analisys.
    ...
    - [[https://github.com/williamboman/mason.nvim][mason]] :: Automatically download Language Servers
      - Default LS installed:
        ...
        - [[https://emmet.io][emmet_language_server]]', and 'html': HTML, CSS, JavaScript
      - Installed manually:
        - [[https://solargraph.org][Solargraph(Ruby)]] :: Moved to config outside neovim due to error installing the solargraph-rails plugin.
        ...
        - [[https://shopify.github.io/ruby-lsp/#with-other-editors][Ruby-LSP]] :: Just ~gem install ruby-lsp~ in the curret Ruby version used.
        - [[https://herb-tools.dev/][Herb]] :: Language server build on top of the HTML-aware ERB(HTML+ERB=HERB) toolchain by [[https://marcoroth.dev/][Marco Roth]]. Install it throght ~npm install -g @herb-tools/language-server~ in the npm available to the project.
